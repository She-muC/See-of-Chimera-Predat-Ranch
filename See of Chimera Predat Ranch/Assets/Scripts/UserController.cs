...
public class UserController : MonoBehaviour {
    ...
    [SerializeField]
    KeyCode m_forwardKey = KeyCode.UpArrow;
    [SerializeField]
    KeyCode m_BackKey = KeyCode.DownArrow;
    [SerializeField]
    KeyCode m_rearKey = KeyCode.RightArrow;
    [SerializeField]
    KeyCode m_frontKey = KeyCode.LeftArrow;
    [SerializeField]
    KeyCode m_upKey = KeyCode.W;
    [SerializeField]
    KeyCode m_downKey = KeyCode.S;
    [SerializeField]
    KeyCode m_attackKey = KeyCode.A;
    [SerializeField]
    KeyCode m_attack2Key = KeyCode.Z;
